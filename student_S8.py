...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3,
        ...
        self.l4 = TCN_GCN_unit(64, 128, A, stride=2,adaptive=adaptive, attention=attention)
        self.l5 = TCN_GCN_unit(128, 128, A, adaptive=adaptive, attention=attention)
        self.l6 = TCN_GCN_unit(128, 128, A, adaptive=adaptive, attention=attention)
        self.l7 = TCN_GCN_unit(128, 256, A, stride=2,adaptive=adaptive, attention=attention)
        self.l8 = TCN_GCN_unit(256, 256, A,  adaptive=adaptive, attention=attention)
